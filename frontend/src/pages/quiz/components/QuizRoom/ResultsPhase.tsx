    ...
    <div className="flex flex-col gap-5">
      <section className="rounded-3xl border border-slate-100 bg-white p-6 shadow-[0_8px_40px_-12px_rgba(15,23,42,0.08)] sm:p-8 lg:p-10">
        ...
        <div className="mb-8 flex flex-col items-center gap-3 text-center">
          ...
          <h2 className="text-slate-900" style={{ fontSize: "22px", fontWeight: 700, letterSpacing: "-0.01em" }}>
            퀴즈 종료!
          </h2>
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col items-end gap-0.5 shrink-0">
                  <span className="text-slate-800" style={{ fontSize: "20px", fontWeight: 700 }}>
                    {p.score}
                  </span>
          ...
          return me ? (
            <div className="mt-6 rounded-2xl border border-blue-100 bg-linear-to-r from-blue-50 to-emerald-50 px-5 py-4">
              <p className="text-slate-600" style={{ fontSize: "14px" }}>
                내 결과: <strong className="text-slate-900">{myRank}위</strong>
                {" · "}
                <strong className="text-slate-900">{me.score}문제 정답</strong>
                {" · 정확도 "}
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-end">
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-5 py-2.5 text-slate-700 transition hover:border-slate-300 hover:bg-slate-50"
