  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <section className="rounded-3xl border border-slate-100 bg-white dark:bg-slate-950 p-6 shadow-[0_8px_40px_-12px_rgba(15,23,42,0.08)] sm:p-8 lg:p-10">
        ...
        {myAnswer !== null && (
          ...
          >
            <div className="flex items-center justify-between gap-3 flex-wrap">
              ...
              {!allAnswered && (
                <span className="inline-flex items-center gap-1.5 text-slate-400 dark:text-slate-500" style={{ fontSize: "13px" }}>
            ...
            <div className="mt-4 flex flex-col gap-3">
              ...
              <div>
                ...
                <ul className="mt-2 flex flex-col gap-2">
                  {quiz.vocab.map((v) => (
                    <li key={v.word} className="rounded-lg border border-white/70 bg-white dark:bg-slate-950/80 px-3.5 py-2.5">
        ...
        {/* 미선택시 넛지 문구 */}
        {myAnswer === null && (
          <p className="mt-5 text-center text-slate-400 dark:text-slate-500" style={{ fontSize: "13px" }}>
            정답을 선택해 주세요
          </p>
        )}
      </section>
